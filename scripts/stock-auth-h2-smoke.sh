...
STOCK_AUTH_SMOKE_BATCH_TOKEN="${STOCK_AUTH_SMOKE_BATCH_TOKEN:-stock-auth-h2-smoke-internal-token}"
...
export STOCK_BATCH_INTERNAL_TOKEN="${STOCK_BATCH_INTERNAL_TOKEN:-${STOCK_AUTH_SMOKE_BATCH_TOKEN}}"
