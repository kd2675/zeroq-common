...
const checks = [
  ...
  ["admin investor category flow uses live async summaries with seven-day history", includesAll(files.stockApi + files.queryLayer + files.types + files.supplyDemandAdmin, [
